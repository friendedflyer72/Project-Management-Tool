  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-900 text-gray-200">
      ...
      <div className="container mx-auto p-4 sm:p-6 lg:p-8 max-w-2xl">
        ...
        {/* --- Profile Form --- */}
        <form onSubmit={handleProfileSubmit} className="bg-gray-800 p-6 rounded-lg shadow-lg mb-8">
        ...
        {/* --- Password Form --- */}
        <form onSubmit={handlePasswordSubmit} className="bg-gray-800 p-6 rounded-lg shadow-lg">
